...
async fn main() -> Result<()> {
    ...
    reasoning_agent.load().await.expect("Échec du chargement structurel de l'Agent");
    ...
    let json_inference = reasoning_agent.generate_thought("Explique moi les axiomes de R2D2 sur l'architecture hexagonale et tokio.").await?;
